...
Feature: Web table user order feature
  ...
  Scenario Template:
    ...
    And user enters expiry date "<cardExp>"
    And user enters process order button
    Then user should see "<expectedName>" in first row of the web table

    @female
    Examples:Famous female scientist
      | productType | quantity | customerName      | Street            | city   | state   | zipCode | cardType | cardNumber       | cardExp    | expectedName      |
    ...
    Examples: Famous male scientist
      ...
      | MoneyCog    | 4        | Alfred Nobel      | 221B Baker Street | London | England | 50505   | masterCard| 1111222233334444 | 12/23      | Alfred Nobel      |
